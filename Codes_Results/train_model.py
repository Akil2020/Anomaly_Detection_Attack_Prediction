# Default: Stratified K-Fold CV (5 folds), 40 random trials per model
    # python ./train_model.py --train_csv ./firewall_train.csv --outdir ./Model_Training_Results
# Time-aware CV (if rows are chronological)
    # python train_model.py --train_csv ./firewall_train.csv --outdir ./Model_Training_Results --cv time
# Faster dry run
    # python train_model.py --train_csv ./firewall_train.csv --outdir ./Model_Training_Results --n_iter 10
import argparse
import json
import os

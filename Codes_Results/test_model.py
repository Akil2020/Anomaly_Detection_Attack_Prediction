# python test_model.py --test_csv ./firewall_test.csv --iso_model ./Model_Training_Results/model_isolation_forest.joblib --clf_model ./Model_Training_Results/model_gb_classifier.joblib --outdir ./Model_Evaluation_Results

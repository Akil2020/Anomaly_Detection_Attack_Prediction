...
# python ./predict.py --input_csv ./firewall_log.csv --iso_model ./Model_Training_Results/model_isolation_forest.joblib --clf_model ./Model_Training_Results/model_gb_classifier.joblib --out ./predictions.csv
